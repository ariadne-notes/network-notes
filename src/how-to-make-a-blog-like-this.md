...
- Use `GitHub Pages` and `Actions` to Deploy [mdBook](https://github.com/rust-lang/mdBook) ... My [deploy script on GitHub](https://github.com/ariadne-notes/networking/blob/main/.github/workflows/mdbook.yml)
